...
const RENDERERS = {
  ...
  "/events": { file: "events.html", render: async (reqUrl, html) => applySeo(html, { title: "Events | Board Night", description: "View events across your Board Night groups.", canonical: `${SITE_URL}/events`, robots: "noindex,follow" }) },
  "/events.html": { file: "events.html", render: async (reqUrl, html) => applySeo(html, { title: "Events | Board Night", description: "View events across your Board Night groups.", canonical: `${SITE_URL}/events`, robots: "noindex,follow" }) },
  "/calendar": { file: "calendar.html", render: async (reqUrl, html) => applySeo(html, { title: "Calendar | Board Night", description: "See your Board Night events organized by date.", canonical: `${SITE_URL}/calendar`, robots: "noindex,follow" }) },
  "/calendar.html": { file: "calendar.html", render: async (reqUrl, html) => applySeo(html, { title: "Calendar | Board Night", description: "See your Board Night events organized by date.", canonical: `${SITE_URL}/calendar`, robots: "noindex,follow" }) },
  "/friends": { file: "friends.html", render: async (reqUrl, html) => applySeo(html, { title: "Friends | Board Night", description: "View people who share Board Night groups with you.", canonical: `${SITE_URL}/friends`, robots: "noindex,follow" }) },
  "/friends.html": { file: "friends.html", render: async (reqUrl, html) => applySeo(html, { title: "Friends | Board Night", description: "View people who share Board Night groups with you.", canonical: `${SITE_URL}/friends`, robots: "noindex,follow" }) },
